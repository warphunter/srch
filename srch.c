...
#    if defined(__MINGW32__)
	while ((ch = getopt(argc, argv, "ht:I:e:E:n:N:i:afdm:wv:r:D:F:M:A:L:B:R:o:O:P:y:Y:W:xzju:U:0qQs:STVH")) != -1)
#    else
	setlocale(LC_ALL, "");
	while ((ch = getopt(argc, argv, "ht:I:e:E:n:N:i:afdlbcpkm:wr:v:D:F:M:A:L:B:R:o:O:P:y:Y:W:xzZjJ:u:U:g:G:0qQs:STVXH")) != -1)
#    endif
	switch (ch) {
		case 't':
			if (*optarg == '*')
