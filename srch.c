...
static int usage()
{
	...
	printf("-C\t\t Clear error messages about deleted files/directories.\n");
	printf("\t\t * Default is to print an error message when a file/directory has been found, but has been deleted before the lstat().\n\n");
